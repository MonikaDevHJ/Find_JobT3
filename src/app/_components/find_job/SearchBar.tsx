...
const SearchBar = () => {
  return (
    <div className="mx-auto mt-10 flex w-full max-w-5xl flex-col items-stretch gap-2 rounded-full  bg-white border border-fuchsia-400 p-2 shadow-2xl sm:flex-row sm:items-center">
      ...
      {/* Button */}
      <button className="w-full rounded-full bg-gradient-to-r bg-fuchsia-600 hover:bg-fuchsia-400 px-6 py-2 text-sm font-medium text-white transition hover:opacity-90 sm:w-auto">
        Search Now
      </button>
    </div>
  );
